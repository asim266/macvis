...
import { Plus, Settings as SettingsIcon, Plug, Sparkles, Folder, MessageSquare, Trash2, Bot, Clock, TerminalSquare } from 'lucide-react'
...
const NAV_ITEMS: { id: Page; icon: React.ReactNode; label: string }[] = [
  ...
  { id: 'terminal', icon: <TerminalSquare size={15} />, label: 'Terminal' },
